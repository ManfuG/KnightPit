...
// Vite's filesystem guard requires the long path, not a Windows 8.3 alias.
export const root = realpathSync.native(resolve(dirname(fileURLToPath(import.meta.url)), ".."));
